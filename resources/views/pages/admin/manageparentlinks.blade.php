					...
					<div class="col-md-12" style="padding-top:0px;position: absolute;bottom:30px;right:50px;" >
						...
						<div class="col-md-9">
								@if(count($data) > 0)
									...
									<div class="col-md-4">
											@if($calendar_id != -1)
												<button onclick='exportCsv("{{ $class_id }}")' type="submit" style="text-align:center;color:#fff;font-size:25px;font-weight: bold;display:block;width:240px;background-color: #00137f;padding:15px 0px;border-radius: 7px;text-decoration: none">
														Export
												</button>
											@endif
											@if($calendar_id == -1)
